                        ...
                        <form action="{{ route('verify-otp') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-4 gap-2 md:gap-8">
                                    <input type="text" name="otp1" class="border-b-4 border-b-[#f590b0] border-t-transparent border-x-transparent bg-[#fff0f5] opacity-100 w-full h-full p-6" maxlength="1" required>
                                    <input type="text" name="otp2" class="border-b-4 border-b-[#f590b0] border-t-transparent border-x-transparent bg-[#fff0f5] opacity-100 w-full h-full p-6" maxlength="1" required>
                                    <input type="text" name="otp3" class="border-b-4 border-b-[#f590b0] border-t-transparent border-x-transparent bg-[#fff0f5] opacity-100 w-full h-full p-6" maxlength="1" required>
                                    <input type="text" name="otp4" class="border-b-4 border-b-[#f590b0] border-t-transparent border-x-transparent bg-[#fff0f5] opacity-100 w-full h-full p-6" maxlength="1" required>
                                </div>
                                @error('otp')
