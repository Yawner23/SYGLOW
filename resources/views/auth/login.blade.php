                    ...
                    <div class="relative flex flex-col items-center justify-between w-full h-full p-12 space-y-12">
                        ...
                        <div class="w-full space-y-4">
                            ...
                            <div class="flex flex-col">
                                <label for="email" class="font-bold">Login</label>
                                <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full h-full rounded-lg border-[#f56e98]" autofocus autocomplete="username">
                                @error('email')
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            <button class="bg-gradient-to-r from-[#f590b0] to-[#f56e98] rounded-lg px-20 py-2 text-white border-2 border-white">LOGIN</button>
